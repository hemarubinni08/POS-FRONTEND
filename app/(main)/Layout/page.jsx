...
const UserProfileCard = ({ user }) => {
  ...
  const gradient = avatarGradients[(user.name?.charCodeAt(0) ?? 0) % avatarGradients.length];
        ...
        <>
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-5 mb-4">
            ...
            <p className="text-gray-500 mt-1 text-sm">
              Delighted to see you again! Explore the sidebar and manage your business efficiently.
            </p>
          </div>
