...
function CommonUpdateTemplate({
  ...
  useEffect(() => {
      ...
      try {
        ...
        extraFields.forEach((field) => {
          ...
          nextValues[field.key] =
            field.asArray && Array.isArray(value) && field.type !== "multiselect" ? value[0] || "" : value ?? "";
        });
    ...
    fetchData();
  }, [apiPath, recordId, recordParam, title, extraFields]);
  ...
  if (pageLoading) {
    return <div className="w-full py-10 text-center text-slate-600">Loading {title.toLowerCase()}...</div>;
  }
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-slate-500">Edit the details for this {title.toLowerCase()}.</p>
      </div>
