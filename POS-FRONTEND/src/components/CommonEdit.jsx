        ...
        >
          ...
          <div>
            ...
            <input
              ...
              value={identifier}
              readOnly
              className="w-full h-14 px-5 rounded-2xl border border-[#d0d5dd] bg-gray-100 text-[#667085] cursor-not-allowed outline-none"
            />
          ...
          <div>
            ...
            <input
              ...
              title="Description cannot be empty or only spaces"
