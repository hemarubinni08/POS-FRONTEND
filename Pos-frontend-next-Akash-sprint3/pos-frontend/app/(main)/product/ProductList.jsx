...
const ProductList = () => {
  ...
  const handleDelete = async (product) => {
    const confirmDelete = globalThis.confirm(`Delete product ${product.identifier}?`);
  ...
  headerExtras={
    <div className="relative flex-grow md:w-72">
      ...
      <input
        ...
        className="w-full pl-10 pr-10 py-2 border border-gray-200 rounded-lg text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
        />
        {searchTerm && (
          <button
